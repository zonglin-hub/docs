...
# 执行容器并执行shell
[root@localhost ~]# docker run -d centos /bin/bash -c "while true; do echo zonglin; sleep 1; done"
...
2022-10-01T15:18:18.647064020Z zonglin
2022-10-01T15:18:19.651083452Z zonglin
2022-10-01T15:18:20.655981698Z zonglin
2022-10-01T15:18:21.659626269Z zonglin
2022-10-01T15:18:22.665580566Z zonglin
[root@localhost ~]# 
[root@localhost ~]# docker top 3913ce5ec9fd # 查看容器进程信息
UID                 PID                 PPID                C                   STIME               TTY                 TIME                CMD
root                72577               72559               0                   23:17               ?                   00:00:00            /bin/bash -c while true; do echo zonglin; sleep 1; done
...
[
    {
        ...
        "Args": [
            "-c",
            "while true; do echo zonglin; sleep 1; done"
        ],
        "State": {
            "Status": "running",
            "Running": true,
